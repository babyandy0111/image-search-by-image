    ...
    try:
        ...
        for i, img_path in enumerate(img_list):
            try:
                ...
                print(f"Error with extracting feature from image:{img_path}, error: {e}")
                continue
        return feats, names
    except Exception as e:
        print(f"Error with extracting feature from image {e}")
        sys.exit(1)
...
def do_count(table_name, milvus_cli):
    ...
    try:
        ...
        print(f"Error with count table {e}")
        sys.exit(1)
...
def do_drop(table_name, milvus_cli):
    ...
    try:
        ...
        print(f"Error with drop table: {e}")
        sys.exit(1)
